...
window.bootbox = window.bootbox || (function init($, undefined) {
  ...
  exports.dialog = function(options) {
    ...
    if(options.message != "")
      body.find(".bootbox-body").html('<center><i class="fa fa-spinner fa-spin fa-fw"></i></center>').load(options.message);
    ...
    if (options.className) {
      ...
      dialog.find(".modal-dialog").addClass(options.className);
    }
