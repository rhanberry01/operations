<?php
	...
	$title =  "CYCLE COUNT-AUTO ".$print_items['branch'];
	...
	$det = array();
	  $det = $CI->operation->get_auto_details2($print_items['id']);
	...
	$content = "
		<table width=\"70%\" cellpadding=\"3px\" border=\"0px\">
			...
			<td style=\"font-size: 12px; font-weight: bold; text-align: center;\">ACTUAL COUNT</td>
